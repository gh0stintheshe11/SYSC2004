...
public class SalesItemTest
{
    ...
    @Test
    public void addThreeComment(){
        SalesItem a = new SalesItem("a",123);
        assertTrue(a.addComment("ab","abc",1));
        assertTrue(a.addComment("bc","bcd",2));
        assertTrue(a.addComment("cd","cde",3));
    }
    
    @Test
    public void addCommentRepeat(){
        SalesItem a = new SalesItem("a",123);
        a.addComment("ab","abc",1); 
        assertFalse(a.addComment("ab","edf",3));
    }
    
    @Test
    public void negativeTestRange(){
        SalesItem a = new SalesItem("a",123);
        assertFalse(a.addComment("ab","abc",0));
        assertFalse(a.addComment("bc","bcd",6));
    }
}
